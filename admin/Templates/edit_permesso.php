...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form form-horizontal" method="POST" action="permessi.php" enctype="multipart/form-data">
                <div class="section">
                    <div class="section-title">Dati Permesso</div>
                    <div class="section-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="tex" class="form-control datepicker" id="created_at" name="created_at" value="<?= $permesso->getCreatedAt() ?>" placeholder="dd/mm/yyyy">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-4 col-md-offset-2">
                            ...
                            <?php if($_REQUEST["id"]) { ?>
                                    ...
                                    <input type="hidden" name="modified_at" value="<?= date("Y-m-d") ?>" />
                              <?php }  ?>
