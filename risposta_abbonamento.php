        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    // sk_live_LX7Ou7JkNNnMwVOZcrFs1jnj
                    // sk_test_fcEZhkTSFym00bd8eENtsrwX
...
if($array["status"] == "succeeded") {
    ...
    $socio = new Soci();
    $socio->load($_SESSION["socioId"]);
    include 'genera_abbonamento.php';
    ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <a href="abbonamenti/<?= $id_permesso ?>-<?= date("Y") ?>.pdf" class="btn btn-lg btn-danger btn-block" target="_blank">SCARICA L'ABBONAMENTO</a>
        </div>
    </div>
