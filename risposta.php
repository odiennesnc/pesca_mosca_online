        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    \Stripe\Stripe::setApiKey("sk_live_LX7Ou7JkNNnMwVOZcrFs1jnj");
                  //  \Stripe\Stripe::setApiKey("sk_test_fcEZhkTSFym00bd8eENtsrwX");
                    ...
                    $charge = \Stripe\Charge::create([
                        'amount' => 1000,
                        'currency' => 'eur',
                        'description' => $socio->getCognome() . ' ' . $socio->getNome() .  ': Ordine singolo',
                        'source' => $token,
                        'metadata' => ['socioId' => $_SESSION["socioId"], 'datauscita' => $_SESSION["datauscita"], 'tipo' => 'singola']]);
...
if($array["status"] == "succeeded") {
    ...
    $array_uscita = array(
        "permesso_id" => $_SESSION["permessoId"],
        "data_uscita" => $_SESSION["datauscita"],
        "codice_uscita" => $codice_uscita
    );

    $uscita = new Uscite();
    $uscita->setSave($array_uscita);
    $uscita->setDataUscita($_SESSION["datauscita"]);
    $id_uscita = $uscita->save();
    if($array["metadata"]["tipo"] == "abbonamento") {
