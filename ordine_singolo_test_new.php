    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-12">
                    <?php if(!$_POST) { ?>
                    <form action="ordine_singolo_test_new.php" name="form_singola" id="form_singola" method="POST" role="form">
                    ...
                    <?php } else {
                        ...
                        if(date("Y-m-d", strtotime($_POST["datauscita"])) >= "2019-10-01") {
                            ...
                            $session = \Stripe\Checkout\Session::create([
                                ...
                                'line_items' => [[
                                    'name' => 'Ordine singolo - data uscita: ' . $_POST["datauscita"],
                                    'description' => 'Ordine singolo - data uscita: ' . $_POST["datauscita"],
                                    // 'images' => ['https://example.com/t-shirt.png'],
                                    'amount' => 1000,
                                    'currency' => 'eur',
                                    'quantity' => 1,
                                ]],
                                'success_url' => 'http://localhost:8888/pesca_mosca/risposta_test_new.php',
                                'cancel_url' => 'http://localhost:8888/pesca_mosca/cancel.php',
                            ]);
