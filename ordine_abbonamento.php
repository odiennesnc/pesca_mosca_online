        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form action="ordine_abbonamento.php" name="form_singola" id="form_singola" method="POST" role="form">
...
Il trattamento è finalizzato esclusivamente allo svolgimento dell’attività istituzionale e per la corretta gestione degli ingressi nel tratto di fiume che insiste nella Z.R.S. Cerreto, gestito dall’Associazione ed in particolare per:<br />
...
<li>proporre reclamo a un'autorità di controllo (Autorità Garante per la protezione dei dati personali – www.garanteprivacy.it).</ul></div>
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <?php } else {
                        ...
                        if($socio->getId() != "" and $socio->getSocio() == "s" and $oggi <= date("Y-m-d", strtotime($socio->getValidoFino()))) {
                            $socio->updateLogin();
                         ...
                         //  $xx = $permessi_socio->getIterator()->count();
                           if($permessi_socio->getIterator()->count() <= 0){
                               ...
                               <div class="col-md-12 text-center">
                                   ...
                                   <!-- pk_live_VEZff85g0cQCndMltOJKPTe4 -->
                                   <!-- pk_test_zCuHdnDDhIYpxIuTsMUuZcDk -->
                                   <form action="risposta_abbonamento.php" method="POST" id="pagamento">
                                       <script
                     ...
                     <?php } else { ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="titoletto text-center">NESSUN SOCIO IN REGOLA CORRISPONDE <br />AI DATI INSERITI</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 col-md-offset-3">
                                    <a href="zrscerreto.php" class="btn btn-block btn-warning btn-lg">TORNA INDIETRO</a>
                                </div>
                                <div class="col-md-3">
