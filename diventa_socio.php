...
//            $id_socio = $socio->save();
            $_SESSION["dati"] = $_POST;
            $_SESSION["numero_tessera"] = Utils::getNumeroTessera();
        } else {
            if($socio->getSocio() == 'n') {
                $check = false;
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <?php } else {
                            if(!$check) {
                                ...
                                $_SESSION["email"] = ($_POST["email"] != "") ? $_POST["email"] : "info@moscaclub.it";
                        ?>
                            <div class="col-md-12 text-center">
                                ...
                                <h2>Hai scelto di pagare Euro <?= str_replace(".", ",", sprintf("%01.2f", $importo)) ?></h2>
                                <!-- pk_live_p6AdOKq8xEKnCJcga39LxCfo -->
                                <!-- pk_test_DGWJAQh5iHOZoVWwkpQ88ive -->
                                <form action="risposta_socio.php" method="POST" id="pagamento">
                                    <script
                                            ...
                                            data-description="Quota socio: &euro; <?= str_replace(".", ",", sprintf("%01.2f", $importo)) ?>"
