    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-12">
                    <?php if(!$_POST) { ?>
                    <form action="ordine_singolo_test.php" name="form_singola" id="form_singola" method="POST" role="form">
...
<li>proporre reclamo a un'autorità di controllo (Autorità Garante per la protezione dei dati personali – www.garanteprivacy.it).</ul></div>
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <?php } else {
                        var_dump($_POST);
                        if(date("Y-m-d", strtotime($_POST["datauscita"])) >= "2019-03-23") {
                                $socio = new Soci();
                        ...
                        <div class="col-md-12 text-center">
                                ...
                                <form action="risposta_test.php" method="POST" id="pagamento">
                                    <script
                    ...
                    <?php } else { ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="titoletto text-center">LA ZRS ENTRA IN VIGORE DAL 23/03/19</h2>
                                </div>
                            </div>
                            <?php } ?>
                <?php } ?>
